...
<body>
 		<div class="page-bar">
			<ul class="page-num-ul clearfix">
				<li>共${param.totalCount}条记录&nbsp;&nbsp; ${param.currentPage}/${param.totalPageCount}页</li>
				<c:if test="${param.currentPage > 1}">
					<a href="javascript:page_nav(document.forms[0],1);">首页</a>
					<a href="javascript:page_nav(document.forms[0],${param.currentPage-1});">上一页</a>
				</c:if>
				<c:if test="${param.currentPage < param.totalPageCount }">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/hotelJs/rollpage.js"></script>
</html>