...
<div class="right">
    ...
    <div class="search">
        <form method="get" action="${pageContext.request.contextPath}/jsp/user.do">
            <input name="method" value="query2" class="input-text" type="hidden">
            <span>用户名：</span>
...
<%--                </td>--%>
                <td>
                    ...
                    <span><a class="allocateLiving" href="javascript:;" confId=${living.confId} confName=${living.confereeName}><img src="${pageContext.request.contextPath}/image/xiugai.png" alt="分配" title="分配"/></a></span>
